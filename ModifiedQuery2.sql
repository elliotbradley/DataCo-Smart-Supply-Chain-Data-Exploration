...
SELECT * FROM Task4
WHERE CustomerCountry != 'Puerto Rico'

#Task 4_2
CREATE TABLE Task4_2 AS
SELECT CustomerState, CustomerCity, SUM(LateDeliveryRisk)/COUNT(LateDeliveryRisk) AS LatenessFrequency FROM dcscd
WHERE CustomerCountry = 'EE. UU.'
GROUP BY CustomerCity
